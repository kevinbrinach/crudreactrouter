    ...
    const agregarProducto = async e => {
        ...
        try {
            const resultado = await  axios.post('http://localhost:4000/restaurant', {
                nombrePlatillo, //como los dos se llaman iguales se puede pasar solo uno, sino seria nombrePlatillo: nombrePlatillo y asi para todos los demas
                precioPlatillo,
                categoria
            });
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Hubo un error agregando el producto, vuelve a intentarlo',
            })
        }
